...
/*function numberOfCarriesDebugVersion(a, b) {
	...
	let copyOf_a, copyOf_b;
	let modulus10_a, modulus10_b, modulus100_a, modulus100_b;
	let divisor = 10;
	let counter = 0;
	const divisor10 = 10, divisor100 = 100;
	let substractorOf_a, substractorOf_b, elseSubstractorOf_a, elseSubstractorOf_b;
	...
	while ((a % divisor !== a) || (b % divisor !== b)) {
		...
		if (modulus10_a + modulus10_b > 9) {
			counter++;
			modulus100_a = copyOf_a % divisor100;

			substractorOf_a = (copyOf_a % divisor100) / divisor100;
			copyOf_a = copyOf_a / divisor100 - substractorOf_a;
		}
...
numberOfCarriesDebugVersion(9991, 1);
